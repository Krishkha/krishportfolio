...
export const EducationStrings = [
  {
    name: "Triveni Vidhyalaya",
...
export const logosStrings = [
  { icon: Logo.email, url: "mailto:khatikarkrish18@gmail.com" },
  { icon: Logo.facebook, url: "https://facebook.com/krish.khatikar" },
  { icon: Logo.instagram, url: "https://instagram.com/krish_khatikar" },
  {
    icon: Logo.linkedin,
